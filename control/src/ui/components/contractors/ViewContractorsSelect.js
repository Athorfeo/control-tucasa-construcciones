...
function ViewContractorsSelect({ data, positionSelected, setPositionSelected, isFormDisable }) {
  ...
  return (
    <div className="mb-3">
      <label htmlFor="labelSupplier" className="form-label">Contratista</label>
...
export default ViewContractorsSelect;
