          ...
          <div className="modal-body">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <input type="number" min="1" max="9999" step="any" className="form-control" id="inputQuantity" aria-describedby="quantityHelp" required value={quantity} onChange={(e) => setQuantity(e.target.value)} ></input>
